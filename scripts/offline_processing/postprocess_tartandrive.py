...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_folder', type=str, required=False, default='local_visual_map', help='name of result folder')
    parser.add_argument('--timestamp_check', action='store_true', help='set this flag to double-check timestamps on data')
    ...
    for ii in tqdm.tqdm(range(len(image_ts))):
        ...
        feature_img, feature_intrinsics = image_pipeline.run(img, intrinsics.unsqueeze(0))
