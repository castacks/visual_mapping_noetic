...
class TerrainDiff(TerrainEstimationBlock):
    ...
    """
    def __init__(self, voxel_metadata, voxel_n_features, terrain_layer, max_elevation_layer, max_elevation_mask_layer, device):
    ...
    def run(self, voxel_grid, bev_grid):
        ...
        diff = max_elevation_data - terrain_data
