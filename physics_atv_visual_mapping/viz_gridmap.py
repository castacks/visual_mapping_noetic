...
def onclick(event):
    ...
    if ix >= 0 and iy >= 0 and ix < gridmap_rgb.shape[1] and iy < gridmap_rgb.shape[0]:
        ...
        gridmap_values = gridmap_npy[iy, ix, :]  # Extract the values from gridmap_npy at the clicked point
        ...
        click_rect = patches.Rectangle((ix - 0.5, iy - 0.5), 1, 1, linewidth=2, edgecolor='r', facecolor='none')
